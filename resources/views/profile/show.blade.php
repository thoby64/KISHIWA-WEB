...
@section('title', 'My Profile - Little Stars Daycare and Nursery School')
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="border-top pt-3">
                                ...
                                <p><strong>Last Login:</strong> {{ Auth::user()->last_login_at ? Auth::user()->last_login_at->format('M d, Y H:i') : 'First Login' }}</p>

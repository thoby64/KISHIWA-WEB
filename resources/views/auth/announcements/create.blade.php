...
@section('title', 'Create Announcement - Little Stars Daycare and Nursery School')
...
<div class="container-xxl py-5 page-header position-relative mb-5">
    <div class="container py-5">
        <h1 class="display-2 text-white animated slideInDown mb-4">Create Announcement</h1>

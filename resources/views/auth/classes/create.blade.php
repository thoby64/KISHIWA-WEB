...
@section('title', 'Create Class - Little Stars Daycare and Nursery School')
...
<div class="container-xxl py-5 page-header position-relative mb-5">
    <div class="container py-5">
        <h1 class="display-2 text-white animated slideInDown mb-4">Create Class</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('auth.classes.index') }}">Classes</a></li>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="bg-light rounded p-4">
            <h3 class="mb-4">Create New Class</h3>

            <form action="{{ route('auth.classes.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="schedule_time" id="schedule_time" class="form-control">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">

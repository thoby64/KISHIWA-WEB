...
@section('title', 'Admin Dashboard - Little Stars Daycare and Nursery School')
            ...
            <div class="col-lg-6 col-12 wow fadeInUp" data-wow-delay="0.1s">
                <div class="bg-light rounded p-4 quick-actions">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6 col-12">
                            <a href="{{ route('auth.appointments.index') }}" class="btn btn-warning w-100 py-3">Manage Appointments</a>
                        </div>
                        <div class="col-md-6 col-12">
                            <a href="{{ route('auth.classes.index') }}" class="btn btn-info w-100 py-3">Manage Classes</a>
                        </div>
                        <div class="col-md-6 col-12">
                            <a href="{{ route('admin.appointment-notifications.index') }}" class="btn btn-secondary w-100 py-3">Appointment Notifications</a>
                        </div>
                        <div class="col-md-6 col-12">
            ...
            <div class="col-12">
                <div class="bg-light rounded p-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <a href="{{ route('admin.audit.index') }}" class="btn btn-warning w-100 py-3">
                                <i class="fa fa-clipboard-list me-2"></i>Audit Logs
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6 col-12">
                            <a href="{{ route('admin.appointment-notifications.index') }}" class="btn btn-info w-100 py-3">
                                <i class="fa fa-envelope me-2"></i>Appointment Notifications
                            </a>
                        </div>
                    </div>
                </div>
